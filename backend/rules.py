...
COUNTRIES = {
    "沙特阿拉伯": ("中东", ["沙特", "Saudi Arabia", "Riyadh", "NEOM"]),
    "阿联酋": ("中东", ["阿联酋", "UAE", "United Arab Emirates", "Dubai", "Abu Dhabi"]),
    "卡塔尔": ("中东", ["卡塔尔", "Qatar"]),
    "科威特": ("中东", ["科威特", "Kuwait"]),
    "以色列": ("中东", ["以色列", "Israel"]),
    "伊拉克": ("中东", ["伊拉克", "Iraq"]),
    "埃及": ("非洲", ["埃及", "Egypt"]),
    "埃塞俄比亚": ("非洲", ["埃塞俄比亚", "Ethiopia"]),
    "阿尔及利亚": ("非洲", ["阿尔及利亚", "Algeria"]),
    "摩洛哥": ("非洲", ["摩洛哥", "Morocco"]),
    "科特迪瓦": ("非洲", ["科特迪瓦", "Côte d'Ivoire", "Cote d'Ivoire", "Ivory Coast"]),
    "肯尼亚": ("非洲", ["肯尼亚", "Kenya"]),
    "南非": ("非洲", ["南非", "South Africa"]),
    "尼日利亚": ("非洲", ["尼日利亚", "Nigeria"]),
    "坦桑尼亚": ("非洲", ["坦桑尼亚", "Tanzania"]),
    "越南": ("东南亚", ["越南", "Vietnam"]),
    "印度尼西亚": ("东南亚", ["印尼", "印度尼西亚", "Indonesia"]),
    "马来西亚": ("东南亚", ["马来西亚", "Malaysia"]),
    "泰国": ("东南亚", ["泰国", "Thailand"]),
    "菲律宾": ("东南亚", ["菲律宾", "Philippines"]),
    "新加坡": ("东南亚", ["新加坡", "Singapore"]),
    "柬埔寨": ("东南亚", ["柬埔寨", "Cambodia"]),
    "巴基斯坦": ("南亚", ["巴基斯坦", "Pakistan"]),
    "孟加拉国": ("南亚", ["孟加拉国", "孟加拉", "Bangladesh"]),
    "哈萨克斯坦": ("中亚", ["哈萨克斯坦", "Kazakhstan"]),
    "乌兹别克斯坦": ("中亚", ["乌兹别克斯坦", "Uzbekistan"]),
    "蒙古国": ("东亚", ["蒙古国", "Mongolia"]),
    "韩国": ("东亚", ["韩国", "South Korea", "Republic of Korea"]),
    "塞尔维亚": ("欧洲", ["塞尔维亚", "Serbia", "Belgrade", "贝尔格莱德"]),
    "法国": ("欧洲", ["法国", "France"]),
    "土耳其": ("欧洲", ["土耳其", "Turkey", "Türkiye"]),
    "美国": ("北美", ["美国", "United States", "USA", "U.S."]),
    "墨西哥": ("拉美", ["墨西哥", "Mexico"]),
    "玻利维亚": ("拉美", ["玻利维亚", "Bolivia"]),
    "巴布亚新几内亚": ("大洋洲", ["巴布亚新几内亚", "Papua New Guinea", "PNG"]),
}
